<?php
/* Smarty version 3.1.32, created on 2018-05-24 20:08:20
  from '/var/www/html/tharlesamaro.com/view/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b0745e45d4824_63373601',
...
function content_5b0745e45d4824_63373601 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="contentpage">
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            <p class="animfadeInUpBig" data-time="1300">
                                <strong>Localização :</strong><br/>Fortaleza, Ceará
                            </p>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            <p class="animfadeInUpBig" data-time="1400">
                                <strong> Telegram :</strong><br/> @tharles
                            </p>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            <p class="animfadeInUpBig" data-time="1500">
                                <strong>Email :</strong><br/> contato@tharlesamaro.com
                            </p>
                        </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            <p class="animfadeInUpBig" data-time="1600">
                                <strong> Nacionalidade :</strong><br/> Brasileiro
                            </p>
                        </div>
                    ...
                    <div class="contentpage">
                        ...
                        <div class="col-md-6 spaceup">
                            <div class="content-skill">
                                <div class="col-skill">
                                    <ul id="listskill">
                                        <li><span class="expand photograhy"><em class="perc">97%</em></span><em><strong>Industrial</strong></em>
                                        </li>
                                        <li><span class="expand photoshop"><em class="perc">70%</em></span><em><strong>Photoshop</strong></em>
                                        </li>
                                        <li><span class="expand potrait"><em class="perc">85%</em></span><em><strong>Potraits</strong></em>
                                        </li>
                                        <li><span class="expand editorial"><em class="perc">78%</em></span><em><strong>Editorial</strong></em>
                                        </li>
